...
public class Code {
    ...
    public static String FAIL_NOT_VALID_MSG= "not valid";
    public static String FAIL_TIME_OVER_MSG= "time over";
    ...
    public static Integer FAIL_NOT_VALID=501;
    public static Integer FAIL_TIME_OVER=502;
